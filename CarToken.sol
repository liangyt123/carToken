...
contract CarToken is SafeMath {
    ...
    /*
        ...
        string tokenName = "CarToken";
        uint8 decimalUnits = 18;
        string tokenSymbol = "CTN";
    */
    function CarToken(
        uint256 initialSupply,
        string tokenName,
    ...
    //getFreezeof
    function getFreeze(address _from) public {
        return freezeOf[_from];
    }
    ...
    function transfer(address _to, uint256 _value) {
        if (_to == 0x0) 
            throw;                               // Prevent transfer to 0x0 address. Use burn() instead
		if (_value <= 0) 
            throw; 
